...
const PairEdit: React.FC<PairEditProps> = ({
  ...
  useEffect(() => {
    async function names() {
      ...
      const result = await onSushiROI(_pairAddress, (_currentTimeStamp-7776000).toString(), '10000', _currentTimeStamp.toString())
      ...
      const resultGraphData = await onSushiROIGraph(_pairAddress, (_currentTimeStamp-7776000).toString(), '10000', _currentTimeStamp.toString())
  ...
  }, [onSushiROI, onSushiROIGraph, pairAddress, timeStamp, amount, symbol0, symbol1, token0Old, token0New, token1Old, token1New, dataObj, dataObj2])
  ...
  return (
    <>
      <Modal>
        <ModalTitle text={`Deposit ${_pairName} Tokens in Sushiswap`} />
